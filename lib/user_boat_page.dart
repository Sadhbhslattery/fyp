...
//  GET /race-results   - per-class results (elapsed + corrected times)
...
class _UserBoatPageState extends State<UserBoatPage> {
  ...
  //   - load today's class results for this boat's class
  @override
  void initState() {
    super.initState();
  ...
  // - If a race officer has selected a course today, the backend returns course + start_time.
  ...
  Widget _buildRaceCard() {
    // We use currentCourse! because this function is only called when it's non-null
    ...
    // Rounds is a List<String> from backend; we join with newlines
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: classResults.map((r) {
                  ...
                  // Extract timing + position fields
