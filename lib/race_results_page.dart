...
class _RaceResultsPageState extends State<RaceResultsPage> {
  ...
  //   VALUE = list of boats + result data from backend
  //
  // Example:
  // {
  //   "White Sail 1": [
  ...
  //   RaceNo, Start, Finish, Elapsed, Code, Place
  ...
  Future<void> _exportSailwaveCsv() async {
    ...
    // Convert the user input into an integer safely
    ...
    //
    // IMPORTANT:
    // - We use dio.options.baseUrl so it always matches your backend host.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // ------------------------------------------------------------
        // ADMIN-ONLY BUTTON (Export to Sailwave)
        // ------------------------------------------------------------
  ...
  // Reference: Card + ListView for grouping by class [F5]
